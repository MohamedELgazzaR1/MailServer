...
public class MainHub extends JFrame {
	...
	public MainHub() {
		...
		refreshBtn.setIcon(new ImageIcon(getClass().getClassLoader().getResource("refresh.jpg")));
		...
		bgImage = new JLabel("");
		bgImage.setIcon(new ImageIcon(getClass().getClassLoader().getResource("opening-email-ss-1920.jpg")));
